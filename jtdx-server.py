...
class WsjtxToCloudlog:
    ...
    def __init__(self):
        ...
        self.cloudlog_station = self.config['DEFAULT']['station']
        self.cloudlog_operator = self.config['DEFAULT']['operator']
        self.reset_vals()
    ...
    def log_new_qso(self):
        ...
        data = {"key": self.cloudlog_key,
                ...
                "<station_callsign:" + str(len(self.cloudlog_station)) + ">" + self.cloudlog_station +
                "<operator:" + str(len(self.cloudlog_operator)) + ">" + self.cloudlog_operator +
                "<eor>"
                }
        print(data)
